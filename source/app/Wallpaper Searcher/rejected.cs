    ...
    public partial class rejected : Form
    {
        ...
        public void AddImage()
        {
            ...
            for (int i = 2; i < data.rejected.Count; i++)
            {
                ...
                checkMark.ImageLocation = @"script\checkmark.png";
        ...
        private void ButtonSelectAll_Click(object sender, EventArgs e)
        {
            ...
            //foreach (PictureBox image in imageList) image.BackColor = Color.Red;
        ...
        private void ButtonSelectCancel_Click(object sender, EventArgs e)
        {
            ...
            //foreach (PictureBox image in imageList) image.BackColor = Color.AliceBlue;
